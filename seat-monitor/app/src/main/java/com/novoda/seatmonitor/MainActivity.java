...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String alertReadyGpioPin = "GPIO23";
        Ads1015 ads10150x48 = new Ads1015.Factory().newDifferentialComparatorInstance(i2CBus, 0x48, gain, alertReadyGpioPin, Ads1015.DifferentialPins.PINS_0_1);
        wiiLoadSensorA = new WiiLoadSensor(ads10150x48);
        Ads1015 ads10150x49 = new Ads1015.Factory().newDifferentialComparatorInstance(i2CBus, 0x49, gain, alertReadyGpioPin, Ads1015.DifferentialPins.PINS_2_3);
