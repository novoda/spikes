...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            i2CBus = service.openI2cDevice("I2C1", 0x48);
        } catch (IOException e) {
            throw new IllegalStateException("Can't open 0x48", e);
        }

        gain = Gain.TWO_THIRDS; /* +/- 6.144V range (limited to VDD +0.3V max!) */
    ...
    private final Runnable loop = new Runnable() {
        ...
        public void run() {
            ...
            Log.d("TUT", "Differential " + readADCDifferentialBetween0And1());

            handler.postDelayed(this, TimeUnit.SECONDS.toMillis(1));
        }
    };

    private int readADCDifferentialBetween0And1() {
