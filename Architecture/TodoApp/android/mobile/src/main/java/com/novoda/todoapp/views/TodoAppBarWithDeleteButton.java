...
public class TodoAppBarWithDeleteButton extends AppBarLayout {

    @LayoutRes
    private int mergeLayoutId;
    private Toolbar toolbar;

    public TodoAppBarWithDeleteButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void obtainCustomAttributes(Context context, AttributeSet attrs) {
        ...
        mergeLayoutId = typedArray.getResourceId(R.styleable.TodoAppBar_mergeLayoutId, R.layout.merge_app_bar_with_delete_button);
        typedArray.recycle();
    }
