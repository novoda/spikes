...
import com.novoda.todoapp.TestUtils;
...
public class TasksScreenTest {
    ...
    public ActivityTestRule<TasksActivity> mTasksActivityTestRule =
            new ActivityTestRule<TasksActivity>(TasksActivity.class) {
                 ...
                 * task, we call {@link TasksService#deleteAllTasks()} before each test.
                 */
                @Override
    ...
    public void clickAddTaskButton_opensAddTaskUi() {
        ...
        onView(withId(R.id.task_title)).check(matches(isDisplayed()));
    }
    ...
    public void editTask() throws Exception {
        ...
        onView(withId(R.id.task_description)).perform(replaceText(editTaskDescription),
    ...
    public void createOneTask_deleteTask() {
        ...
        onView(withId(R.id.delete_task_button)).perform(click());
    ...
    private void createTask(String title, String description) {
        ...
        onView(withId(R.id.task_title)).perform(typeText(title),
                closeSoftKeyboard()); // Type new task title
        onView(withId(R.id.task_description)).perform(typeText(description),
                closeSoftKeyboard()); // Type new task description and close the keyboard
